...
def label_eval(model_name, model, test_sentences, true_labels):
    ...
    if "wave" in model_name:
        true_labels = ['True First Wave', 'True Second Wave']
        predicted_labels = ['Predicted First Wave', 'Predicted Second Wave']
    else:  # gen
        true_labels = ['True First Gen', 'True Second Gen']
        predicted_labels = ['Predicted First Gen', 'Predicted Second Gen']
    ...
    if "wave" in model_name:
        ax.set_title("Wave Confusion Matrix", fontsize=18)
    else:  # gen
